...
public class ParseInvalidPacs002 {
    ...
    public static void makeValidPacs002Invalid() {
        ...
        try {
            ...
            messageObject.getRootMessage().getGrpHdr().getInstgAgt().setFinInstnId(null);
            ...
            Line: -1 -- cvc-complex-type.2.4.b: The content of element 'InstgAgt' is not complete. One of '{"urn:iso:std:iso:20022:tech:xsd:pacs.002.001.03S2":FinInstnId}' is expected.
             */
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void parseInvalidPacs002() {
        ...
        try {
            //Use parseAndValidateString() to fill the messageObject the content of the message and validate it
            //validation fills the message variable errors object with any issue found during validation
            messageObject.parseAndValidateString(invalidPacs002String);
            Utils.printValidMessageOrErrors(messageObject);

            /* The following error message should be visible when running this example:
            Message is invalid, and the errors are the following:
            Line: 8 -- cvc-complex-type.2.4.b: The content of element 'InstgAgt' is not complete. One of '{"urn:iso:std:iso:20022:tech:xsd:pacs.002.001.03S2":FinInstnId}' is expected.
             */
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("Message cannot be parsed");
